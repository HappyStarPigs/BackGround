...
import AppuserList from './views/appuser/AppuserList.vue'
import AccountList from './views/appuser/AccountList.vue'
import AppUserSign from './views/appdata/AppUserSign.vue'
import DataStatistics from './views/appdata/DataStatistics.vue'
import AppLoginLog from './views/appdata/AppLoginLog.vue'
...
let router = [
    ...
    },
    {
        ...
        children: [
            { path: '/AppuserList', component: AppuserList, name: '用户账号管理' },
            { path: '/AccountList', component: AccountList, name: '用户笔记管理' },
        ]
    },
    {
        path: '/',
        ...
        iconCls: 'icon iconfont icon-yonghurenxiang',
        children: [
            { path: '/AppUserSign', component: AppUserSign, name: '签到数据' },
            { path: '/DataStatistics', component: DataStatistics, name: '数据统计' },
            { path: '/AppLoginLog', component: AppLoginLog, name: '登录日志' },
        ]
    },
    {
        path: '/',
